...
For an interactive analysis of the 4-bar linkage, see [fourbar_GUI.html](https://haijunsu-osu.github.io/kinematics_4bar/fourbar_GUI.html). Click here for the demo video ([demo.mp4](https://haijunsu-osu.github.io/kinematics_4bar/demo.mp4))
